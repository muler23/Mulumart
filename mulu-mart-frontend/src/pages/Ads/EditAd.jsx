...
const EditAd = () => {
  ...
  useEffect(() => {
    if (ad && user?._id !== ad.postedBy._id) {
  ...
  const removeNewImage = (index) => {
    ...
    const newPreviews = imagePreviews.slice(existingImages.length).filter((_, i) => i !== index);
    setImages(newImages);
  ...
  const onSubmit = async (data) => {
    ...
    formData.append('location[country]', data.country || 'Ethiopia');
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-gray-600 mt-1">Update your ad details</p>
          </div>
